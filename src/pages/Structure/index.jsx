...
export function Structure() {
    ...
    const openLocationProducts = (location, mode = "create") => {
        setLocationProductsDialog({ location, mode });
    ...
    const saveLocationProducts = async () => {
        ...
        const locationId = locationProductsDialog.location.id;
    ...
    return (
        <main className="structure-page">
                            ...
                            <aside className="structure-detail-panel">
                                {selectedLocation ? (
                                    <>
                                        ...
                                        <div className="structure-detail-actions" aria-label="Ações do local">
                                            {canEdit && <div className="structure-detail-actions__group">
                                                <Button icon={<AppIcon name="plus" />} label="Adicionar sublocal" onClick={() => openSubstructureCreate(null, selectedContract, selectedLocation)} />
                                            </div>}
                                            {(canEdit || canCreateRoutine) && <div className="structure-detail-actions__group structure-detail-actions__group--manage">
                                            ...
                                            {canEdit && <div className="structure-detail-actions__group structure-detail-actions__group--danger">
                                                <Button icon={<AppIcon name="trash" />} label="Excluir local" severity="danger" text onClick={(event) => removeItem(event, "local", selectedLocation)} />
                                            </div>}
                                        </div>
                                        ...
                                        <section className="structure-assets-panel">
                                            ...
                                            {canEdit && <div className="structure-assets-panel__actions">
                                                <Button
                                                    icon={<AppIcon name="plus" />}
                                                    label="Adicionar produto"
                                                    onClick={() => openLocationProducts(selectedLocation, "create")}
                                                />
                                                {selectedLocationProducts.length > 0 && <Button
                                                    icon={<AppIcon name="pencil" />}
                                                    label="Gerenciar produtos"
                                                    outlined
                                                    onClick={() => openLocationProducts(selectedLocation, "manage")}
                                                />}
                                            </div>}
                                        </section>
            ...
            <Dialog
                header={locationProductsDialog ? `${locationProductsDialog.mode === "manage" ? "Gerenciar produtos" : "Adicionar produto"} — ${locationProductsDialog.location.nome}` : "Produtos no local"}
                ...
                footer={(
                    <div className="structure-dialog-footer">
                        ...
                        <Button label={locationProductsDialog?.mode === "manage" ? "Salvar alterações" : "Salvar produto"} icon={<AppIcon name="check" />} onClick={saveLocationProducts} />
                    </div>
                )}
            >
                <StructureProductLocation
                    ...
                    mode={locationProductsDialog?.mode}
                />
            </Dialog>
            <ConfirmDialog />
        </main>
