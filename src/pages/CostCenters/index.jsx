...
const EMPTY = { empresa_id: null, numero: null, nome: "", capacidade_pessoas: null, supervisor_usuario_ids: [] };
...
export function CostCentersPage() {
  ...
  useEffect(() => {
    ...
    connect.get("/centro/empresas", { skipStandardFilters: true })
      ...
      .catch(() => {});
    connect.get("/centro/supervisores", { skipStandardFilters: true })
      .then(({ data }) => setSupervisors((data || []).map((item) => ({ label: item.nome, value: item.id }))))
      .catch(() => showToast("error", "Supervisores", "Não foi possível carregar os supervisores."));
  }, [isAdmin, showToast]);
