...
export function exportTechnicalReservationsXlsx(reservations) {
  ...
  const lastRow = Math.max(1, reservations.length + 1);
...
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  const files = {
    ...
    "xl/workbook.xml": strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="Reservas Técnicas" sheetId="1" r:id="rId1"/></sheets></workbook>`),
  ...
  anchor.href = url;
  anchor.download = `reservas_tecnicas_${new Date().toISOString().slice(0, 10)}.xlsx`;
  anchor.click();
